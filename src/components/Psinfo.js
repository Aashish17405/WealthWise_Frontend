...
const Psinfo = ({ mail }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        process.env.REACT_APP_BACKEND_URL + "expense/submitdata",
        { formData },
        {
          headers: {
  ...
  const updateCount = async () => {
    ...
    try {
      const getCookie = Cookies.get("sessionToken");
      const response = await axios.post(
        process.env.REACT_APP_BACKEND_URL + "expense/updatecount",
        { email },
        {
          headers: {
            Authorization: `Bearer ${getCookie}`,
          ...
          >
            ...
            >
              ...
              <p className="mb-4" style={{ color: colors.text }}>
                Your information has been submitted successfully. Redirecting in{" "}
                  ...
                  >
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor:
                            !formData.income || !formData.city || !formData.age
                              ? "#A5D6A7"
                              : "#66BB6A",
                          color: "white",
                        }}
                  ...
                  >
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor:
                            !formData.housing || !formData.transportation
                              ? "#A5D6A7"
                              : "#66BB6A",
                          color: "white",
                        }}
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor:
                            !formData.foodAtHome ||
                            !formData.foodAwayFromHome ||
                            !formData.alcoholicBeverages
                              ? "#A5D6A7"
                              : "#66BB6A",
                          color: "white",
                        }}
                  ...
                  >
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        style={{
                          backgroundColor:
                            !formData.personalCare ||
                            !formData.apparelAndServices ||
                            !formData.tobaccoProducts
                              ? "#A5D6A7"
                              : "#66BB6A",
                          color: "white",
                        }}
